...
// Access: http://localhost:8000/install_fosckeditor.php
...
echo "Next steps:\n";
echo "1. Run 'composer install' in your terminal to download the package\n";
echo "2. Restart your Symfony server\n";
echo "3. The FOSCKEditor error should be resolved\n";
?>
